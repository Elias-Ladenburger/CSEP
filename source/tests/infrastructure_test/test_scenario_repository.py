...
from domain.scenario_design.scenario import Scenario, BaseStory, Story
...
class ScenarioPersistenceTest(TestCase):
    ...
    def test_modify_scenario(self):
        original_scenario = ScenarioRepository.get_scenario_by_id(scenario_id=self.test_scenario.scenario_id)

        scenario = Scenario(**original_scenario.dict())
        ...
        changed_scenario = ScenarioRepository.get_scenario_by_id(scenario_id=self.test_scenario.scenario_id)
