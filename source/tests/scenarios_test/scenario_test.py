...
from domain.scenario.scenario import Story, Inject, StoryGraph, Transition
...
class StoryTest(unittest.TestCase):
    ...
    def test_create_complete_scenario(self):
        inject_intro = Inject(title="intro inject", description="Welcome to this scenario!")
        inject_last = Inject(title="last inject", description="Thank you for playing the scenario!")
