!function (t) {
    ...
    t.fn.tagsInput = function (n) {
        const i = t.extend({
            tagClass: "badge badge-tag",
            tagsContainerClass: "form-control",
            highlightColor: "#ffc107"
        }, n), a = new e, o = function (t) {
        ...
        this.each(function () {
            ...
            const e = this.hasAttribute("disabled"), n = o(e), r = function (t) {
        ...
        const n = t(this), i = n.parent(), a = i.parent().prev(), o = n.siblings("span").text(),
            r = `(^${o};)|(;${o};)`, s = a.val().replace(new RegExp(r, "u"), ";");
        a.val(s), i.remove()
